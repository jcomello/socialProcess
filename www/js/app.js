...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    .state('tab.rule-questions', {
      url: '/process/:processId/rules/:ruleId/questions',
      views: {
        'tab-processes': {
          templateUrl: 'templates/rule-questions.html',
  ...
  $urlRouterProvider.otherwise('/tab/processes');
});
